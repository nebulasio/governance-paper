...
\begin{enumerate}
	...
	If a problem arises on the network, improvements can be quickly be released to the entire network. Future problems on Nebulas will not be like those on existing public chains such as Ethereum which are bound by is consensus mechanisms or immature technologies and strategies.
