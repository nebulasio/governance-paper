...
\subsection{质押部分}
<<<<<<< HEAD
质押部分获得的NAT应少于使用该部分NAS提升星云指数获得的部分。根据星云指数的性质可知，给定NAS，其存在星云指数的上限$h(d_{i,j})$~\cite{ImproveNR}，
=======
质押部分获得的NAT应与部分NAS提升星云指数获得的空投部分存在相关性。根据星云指数的性质可知，给定NAS，其存在星云指数的上限$h(d_{i,j})$~\cite{ImproveNR}，

>>>>>>> 395e8d8a766f047465f8f1a96da570468399167f
则质押部分获得的NAT为：
\begin{align}
